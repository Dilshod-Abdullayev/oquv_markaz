...
export default function Education() {
    return (
        <div className='p-4'>
            <Education_top />
            <div className='mt-6 flex max-sm:flex-col max-sm:items-center  justify-between flex-wrap'>
                <div className='cursor-pointer hover:bg-slate-700 hover:text-white transition-all w-72 p-4 rounded-3xl shadow-2xl h-80 bg-white mt-2'>
